...
<body>
    <header>
        ...
        <div id="register-form" class="form-container form-login container animate__animated">
            ...
            <form id="contact-form" method="post" class="contact-form" action="/user/create.php">
        ...
        <div id="forgot-password" class="form-container form-login container animate__animated">
            ...
            <form id="contact-form" method="post" class="contact-form" action="forget.php">
                <label class="one-label" for="email">Email*</label>
        ...
        <div class="guest">
            <a href="guest.html"><p>Continue as a Guest</p></a>
        </div>
 </header>
