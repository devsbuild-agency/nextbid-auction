  ...
  <section id="header"> 
    ...
    <div class="navbar-links">
      <ul class="navbar">
        ...
        <li><a href="/item/add_product.php">Add Product</a></li>
      </ul>
    </div>
    ...
    <div class="wrapper cards">
      ...
      <div class="card auction-card">
        <div class="auction-card-img">
          <a href="/item/Ishow.php?item_name=<?php echo $row['item_name']?>"><img src="images/<?php echo $row['item_photo']?>" alt="Product Image" width="300" height="300" style="background-color: #d4f8f4; "></a>
        </div>
